...
public object JsonWebKeys {
    ...
    // For RSA JWK: unsigned big-endian integers need leading zeros trimmed (RFC 7518 Section 6.3)
    private fun JsonObjectBuilder.putUnsigned(key: String, value: ByteArray) {
        put(key, value.trimLeadingZeros())
    }
